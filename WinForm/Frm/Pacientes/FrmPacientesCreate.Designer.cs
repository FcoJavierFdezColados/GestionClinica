namespace WinForm.Frm.Pacientes
{
    partial class FrmPacientesCreate
    {
        ...
        {
            btnAceptarFrmPacientesCreate = new Button();
            btnCancelarPacientesCreate = new Button();
            lblNombreFrmPacientesCreate = new Label();
            tbNombreFrmPacientesCreate = new TextBox();
            tbTelefono1FrmPacientesCreate = new TextBox();
            tbApellidosFrmPacientesCreate = new TextBox();
            tbTelefono2FrmPacientesCreate = new TextBox();
            tbDireccionFrmPacientesCreate = new TextBox();
            tbProvinciaFrmPacientesCreate = new TextBox();
            tbPoblacionFrmPacientesCreate = new TextBox();
            tbCodigoPostalFrmPacientesCreate = new TextBox();
            lblApellidosFrmPacientesCreate = new Label();
            lblDireccionFrmPacientesCreate = new Label();
            lblPoblacionFrmPacientesCreate = new Label();
            lblCodigoPostalFrmPacientesCreate = new Label();
            lblPacientesProviciaFrmCreate = new Label();
            lblTelefono2FrmPacientesCreate = new Label();
            lblTelefono1FrmPacientesCreate = new Label();
            SuspendLayout();
            // 
            // btnAceptarFrmPacientesCreate
            // 
            ...
            btnAceptarFrmPacientesCreate.Text = "Aceptar";
            btnAceptarFrmPacientesCreate.UseVisualStyleBackColor = true;
            btnAceptarFrmPacientesCreate.Click += btnAceptarFrmPacientesCreate_Click;
            // 
            // btnCancelarPacientesCreate
            // 
            ...
            btnCancelarPacientesCreate.Text = "Cancelar";
            btnCancelarPacientesCreate.UseVisualStyleBackColor = true;
            btnCancelarPacientesCreate.Click += btnCancelarPacientesCreate_Click;
            // 
            ...
            lblNombreFrmPacientesCreate.Text = "Nombre";
            // 
            ...
            lblApellidosFrmPacientesCreate.Text = "Apellidos";
            // 
            ...
            lblDireccionFrmPacientesCreate.Text = "Dirección";
            // 
            ...
            lblPoblacionFrmPacientesCreate.Text = "Población";
            // 
            ...
            lblCodigoPostalFrmPacientesCreate.Text = "Código Postal";
            // 
            ...
            lblTelefono2FrmPacientesCreate.Text = "Teléfono 2";
            // 
            ...
            lblTelefono1FrmPacientesCreate.Text = "Teléfono 1";
            // 
            // FrmPacientesCreate
            // 
            AcceptButton = btnAceptarFrmPacientesCreate;
            ...
            Controls.Add(lblCodigoPostalFrmPacientesCreate);
            Controls.Add(lblPoblacionFrmPacientesCreate);
            Controls.Add(lblDireccionFrmPacientesCreate);
            Controls.Add(lblApellidosFrmPacientesCreate);
            Controls.Add(tbCodigoPostalFrmPacientesCreate);
            Controls.Add(tbPoblacionFrmPacientesCreate);
            Controls.Add(tbProvinciaFrmPacientesCreate);
            Controls.Add(tbDireccionFrmPacientesCreate);
            Controls.Add(tbTelefono2FrmPacientesCreate);
            Controls.Add(tbApellidosFrmPacientesCreate);
            Controls.Add(tbTelefono1FrmPacientesCreate);
            Controls.Add(tbNombreFrmPacientesCreate);
            Controls.Add(lblNombreFrmPacientesCreate);
        ...
        private Button btnAceptarFrmPacientesCreate;
        private Button btnCancelarPacientesCreate;
        private Label lblNombreFrmPacientesCreate;
        private TextBox tbNombreFrmPacientesCreate;
        private TextBox tbTelefono1FrmPacientesCreate;
        private TextBox tbApellidosFrmPacientesCreate;
        private TextBox tbTelefono2FrmPacientesCreate;
        private TextBox tbDireccionFrmPacientesCreate;
        private TextBox tbProvinciaFrmPacientesCreate;
        private TextBox tbPoblacionFrmPacientesCreate;
        private TextBox tbCodigoPostalFrmPacientesCreate;
        private Label lblApellidosFrmPacientesCreate;
        private Label lblDireccionFrmPacientesCreate;
        private Label lblPoblacionFrmPacientesCreate;
        private Label lblCodigoPostalFrmPacientesCreate;
        private Label lblPacientesProviciaFrmCreate;
        private Label lblTelefono2FrmPacientesCreate;
        private Label lblTelefono1FrmPacientesCreate;
    }
}